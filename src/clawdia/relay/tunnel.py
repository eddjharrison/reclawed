"""Named Cloudflare tunnel management.

Supports stable tunnel URLs that persist across daemon restarts.
Requires a Cloudflare account and a domain on Cloudflare DNS.

Setup flow (one-time):
    clawdia tunnel setup relay.yourdomain.com

Runtime: the daemon co-manages the tunnel process alongside the relay server.
"""
